...
stopifnot(all(args %in% "--from-panels"))
if ("--from-panels" %in% args) {
  scripts <- scripts[!grepl("^0[1-3]", scripts) & scripts != "08a_phone_survey_tables.R"]
  message("Using committed analysis panels and survey tables.")
}
