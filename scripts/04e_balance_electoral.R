...
raj_tex <- c(
  ...
  "\\midrule",
  paste0(
    "N & \\multicolumn{3}{c}{", fmt_int(nrow(raj_05_10)), "} & ",
...
up_tex <- c(
  ...
  "\\midrule",
  paste0(
    "N & \\multicolumn{3}{c}{", fmt_int(nrow(up_05_10)), "} & ",
...
combined_tex <- c(
  ...
  "\\vspace{0.5ex}",
  paste0(
    "\\parbox{\\linewidth}{\\scriptsize \\emph{Notes:} Balance tests for quota assignment ",
