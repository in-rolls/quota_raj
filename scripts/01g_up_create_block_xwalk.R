...
message("=== Creating Comprehensive UP Block Crosswalk ===")
...
district_xwalk <- read_csv(here("data/crosswalks/active/up_district_xwalk.csv"),
                           show_col_types = FALSE)

message("District crosswalk loaded: ", nrow(district_xwalk), "entries")
...
message("Manual crosswalk defined: ", nrow(block_xwalk), "entries")
...
message("Urban wards excluded: ", nrow(urban_wards))
...
message("Total unique election blocks: ", nrow(elex_blocks))
...
message("\n=== CROSSWALK SUMMARY ===")
message("Total entries: ", nrow(block_xwalk))
message("Urban wards excluded: ", nrow(urban_wards))
