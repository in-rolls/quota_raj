...
m_raj_0510_fe <- feols(female_res_2010 ~ treat_2005 | dist_samiti_2010, data = raj_05_10, fixef.rm = "singleton")
...
m_raj_1015_fe <- feols(female_res_2015 ~ treat_2010 | dist_samiti_2015, data = raj_10_15, fixef.rm = "singleton")
...
m_raj_1520_fe <- feols(female_res_2020 ~ treat_2015 | dist_samiti_2020, data = raj_15_20, fixef.rm = "singleton")
